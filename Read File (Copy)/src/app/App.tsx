...
const PatientLayout     = lazy(() => import("./components/patient/PatientLayout").then(m => ({ default: m.PatientLayout })));
const PatientDashboard  = lazy(() => import("./components/patient/PatientDashboard").then(m => ({ default: m.PatientDashboard })));
const TreatmentCycles   = lazy(() => import("./components/patient/TreatmentCycles").then(m => ({ default: m.TreatmentCycles })));
const BloodWork         = lazy(() => import("./components/patient/BloodWork").then(m => ({ default: m.BloodWork })));
const SymptomJournal    = lazy(() => import("./components/patient/SymptomJournal").then(m => ({ default: m.SymptomJournal })));
const PatientMessages   = lazy(() => import("./components/patient/PatientMessages").then(m => ({ default: m.PatientMessages })));
const PatientProfilePage = lazy(() => import("./components/PatientProfile").then(m => ({ default: m.PatientProfile })));
const OncologistDashboard = lazy(() => import("./components/oncologist/OncologistDashboard").then(m => ({ default: m.OncologistDashboard })));
const PatientDetail     = lazy(() => import("./components/oncologist/PatientDetail").then(m => ({ default: m.PatientDetail })));
const LabStaffDashboard = lazy(() => import("./components/labstaff/LabStaffDashboard").then(m => ({ default: m.LabStaffDashboard })));
