...
export function LoadingSpinner({ message = 'Loading your data...' }: { message?: string }) {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-4" style={{ backgroundColor: '#FAF8F5', position: 'relative' }}>
      <RibbonBackground />
      ...
      <p style={{ color: '#7CAE8E', fontFamily: 'Nunito, sans-serif' }} className="text-sm relative z-10">
        {message}
      </p>
    </div>
  );
